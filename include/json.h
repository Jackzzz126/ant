...
public:
	...
	void SetValue(JSONNODE* node, const string& key, const string& str);
	void SetValue(JSONNODE* node, const string& key, bool value);
	void SetValue(JSONNODE* node, const string& key, const vector<int>& array);
	void SetValue(JSONNODE* node, const string& key, const vector<float>& array);
	void SetValue(JSONNODE* node, const string& key, const vector<string>& array);
